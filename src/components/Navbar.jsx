...
function Navbar() {
  ...
  return (
    <div className=' bg-white flex justify-between px-10 h-20  items-center py-11 border-b-[1px] border-gray-300 fixed w-screen'>
        ...
        <ul className='hidden md:flex'>
            ...
            <li className='p-3 mx-5 text-2xl cursor-pointer tracking-[0.7em] font-semibold '>THE BLOG</li>
